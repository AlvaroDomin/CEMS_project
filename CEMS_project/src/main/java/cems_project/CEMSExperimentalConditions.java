...
public class CEMSExperimentalConditions {
    ...
    private String RMTRefCompoundName;
    private Double RMTRefMT;
    private Integer RMTRefID;
    ...
    public CEMSExperimentalConditions(String label, BufferEnum buffer, Integer temperature, IonizationMode ionizationMode, Polarity polarity,
                                      ...
                                      String RMTRefCompoundName, Double RMTRefMT, Double RMTRefID) {
        this.label = label;
        this.buffer = buffer;
        ...
        this.RMTRefCompoundName = RMTRefCompoundName;
        this.RMTRefMT = null;
        this.RMTRefID = null;
    }
    ...
    public CEMSExperimentalConditions(String label, BufferEnum buffer, Integer temperature, IonizationMode ionizationMode, Polarity polarity,
        ...
        this(label,buffer,temperature,ionizationMode,polarity,ref_compound_id_RMT, sampleType_int,
                ...
                null, null, null, null, 0d, null, null, null, null, null);
    }
    ...
    public CEMSExperimentalConditions(String label, BufferEnum buffer, Integer temperature, IonizationMode ionizationMode, Polarity polarity,
        ...
        this(label, buffer,temperature,ionizationMode,polarity,ref_compound_id_RMT, sampleType_int,
                null,null,null, null,
                capillaryLength, voltage, electricField,mtEOF, 0d, null, null, null, null, null);
    }
    ...
    public CEMSExperimentalConditions(String label, BufferEnum buffer, Integer temperature, IonizationMode ionizationMode, Polarity polarity,
        ...
        this(label, buffer,temperature,ionizationMode,polarity,ref_compound_id_RMT, sampleType_int,
                ...
                null, mtEOF, 0d, null, null, null, null, null);
    }
    ...
    public String getRMTRefCompoundName() {
        return RMTRefCompoundName;
    }
    public Double getRMTRefMT() {
        return RMTRefMT;
    }
    public void setRMTRefMT(Double RMTRefMT) {
        this.RMTRefMT = RMTRefMT;
    }
    public Integer getRMTRefID() {
        return RMTRefID;
    }
    public void setRMTRefID(Integer RMTRefID) {
        this.RMTRefID = RMTRefID;
    }
