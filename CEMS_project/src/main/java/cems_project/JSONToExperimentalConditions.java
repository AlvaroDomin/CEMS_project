    ...
    public static List<CEMSExperimentalConditions> main() {
        ...
        try {
            Object obj = parser.parse(new FileReader(Constants.RESOURCES_PATH +
                    "json/experimental_conditions_v10.json"));
            ...
            for (int i = 0; i < fileList.size(); i++) {
                ...
                Object RMTRefCompoundName = value_json.get("rmt_ref_compound_name");
                String RMTRefCompoundName_string = RMTRefCompoundName.toString();
                ...
                CEMSExperimentalConditions cemsExperimentalConditions = new CEMSExperimentalConditions(
                        ...
                        mtEOF_double, 0d, null, null, RMTRefCompoundName_string,
                        null, null);
