...
public class ConstantQueries {
    ...
    public static final String SELECT_CE_EFF_MOB_ID = "SELECT ce_eff_mob_id FROM eff_mob WHERE compound_id = ? AND eff_mob_exp_prop_id = ?";
    ...
    public static final String COUNT_CE_EXP_PROP_METADATA = "SELECT COUNT(*) FROM ce_experimental_properties_metadata WHERE ce_exp_prop_id = ? AND compound_id = ?";
    public static final String SELECT_EFF_MOB = "SELECT eff_mobility FROM eff_mob WHERE eff_mob_id = ?";
